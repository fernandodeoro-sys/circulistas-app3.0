...
<!-- Título de Sección -->
<div class="mb-8">
    <h1 class="text-3xl font-bold tracking-tight text-slate-900">Nuevo Evento</h1>
    <p class="mt-1.5 text-sm text-slate-500">Ingresa los datos para registrar un nuevo retiro o jornada.</p>
</div>
            ...
            <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="numero_evento" id="numero_evento" value="{{ old('numero_evento') }}" min="1"
            ...
            <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm space-y-4">
                ...
                <div>
                    ...
                    <textarea name="observaciones" id="observaciones" rows="4"
                              ...
                              placeholder="Detalles organizativos o notas generales...">{{ old('observaciones') }}</textarea>
                </div>
            </div>

            <!-- Carga de Fotos -->
            <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm space-y-4">
                <h2 class="text-base font-bold text-slate-900 border-b border-slate-100 pb-3">Galería y Fotos</h2>
